...
Scenario A was supposed to be indicated by the _queue game_ tag. Unfortunately we found, that deciding when a game falls into this category was difficult, since ultimately every game gives the player a list or queue of tasks that needs to be processed.
