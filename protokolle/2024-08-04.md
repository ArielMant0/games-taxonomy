...
- Add issue to application: crawl average playtime via steam ([collacode Issue 51](https://github.com/ArielMant0/collacode/issues/51))
...
Further idea were added to issue #60 (sandbox, arcade, bonuslevel).
